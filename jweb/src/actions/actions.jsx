...
export function addTodo(text){
  return dispatch=>{
    ...
    return fetch('http://localhost:8080/event',{method:'post',headers:headers,body:JSON.stringify(data)}).then(
...
export function fetchTodoList(){
 return dispatch=>{ return fetch('http://localhost:8080/event')
